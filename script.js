...
document.title="👨‍⚕️ Come Back | Dr. V K Navkar";

}else{

document.title="Dr. V K Navkar | General Physician";
...
if (appointmentForm) {
    ...
    appointmentForm.addEventListener("submit", function (e) {
        ...
        window.open(
            ...
            `https://wa.me/917692223545?text=${whatsappMessage}`,
...
setTimeout(()=>{
    ...
    showToast("Welcome to Dr. V K Navkar Clinic","success");
